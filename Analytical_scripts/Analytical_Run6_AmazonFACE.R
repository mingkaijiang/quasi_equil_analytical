...
#### Analytical script AmazonFACE parameters, variable wood, P cycle off
####
#### Assumptions:
#### 1. P cycle off
#### 2. Variable wood 
...
Perform_Analytical_Run6_AmazonFACE <- function(f.flag = 1, cDF, eDF) {
    ...
    if (f.flag ==1 ) {
        ...
        tiff("Plots/Analytical_Run6_AmazonFACE.tiff",
        ...
        plot(nfseq,C350,axes=T,
             type='l',xlim=c(0.01,0.08),ylim=c(0.8,4), 
