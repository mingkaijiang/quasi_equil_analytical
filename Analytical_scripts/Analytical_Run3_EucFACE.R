...
#### Analytical script for EucFACE parameters, fixed wood, P cycle on
####
#### Assumptions:
#### 1. N and P cycle on
...
Perform_Analytical_Run3_EucFACE <- function(f.flag) {
    ...
    #    ######### Plotting
    #    
    #    tiff("Plots/Analytical_Run3_EucFACE.tiff",
    ...
    #    tiff("Plots/Analytical_Run3_2d_EucFACE.tiff",
