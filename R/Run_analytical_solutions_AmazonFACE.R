...
###         = 3 return equilDF
Perform_Analytical_Run1_AmazonFACE(f.flag = 1, constraintDF, equilDF)
Perform_Analytical_Run2_AmazonFACE(f.flag = 1, constraintDF, equilDF)

#### Step 2 store run 1 - 10 constrainDF dataframe

### Run 1
constraintDF <- Perform_Analytical_Run1_AmazonFACE(f.flag = 2, constraintDF, equilDF)

### Run 2
constraintDF <- Perform_Analytical_Run2_AmazonFACE(f.flag = 2, constraintDF, equilDF)
...
### Run 1
equilDF <- Perform_Analytical_Run1_AmazonFACE(f.flag = 3, constraintDF, equilDF)

### Run 2
equilDF <- Perform_Analytical_Run2_AmazonFACE(f.flag = 3, constraintDF, equilDF)
