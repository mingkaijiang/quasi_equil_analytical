...
Perform_Analytical_Run1_AmazonFACE(f.flag = 1)
Perform_Analytical_Run2_AmazonFACE(f.flag = 1)
...
r5 <- Perform_Analytical_Run1_AmazonFACE(f.flag = 2)
r6 <- Perform_Analytical_Run2_AmazonFACE(f.flag = 2)
