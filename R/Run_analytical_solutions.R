...
Perform_Analytical_Run8_2(f.flag = 1, constraintDF, equilDF)
...
constraintDF <- Perform_Analytical_Run8_2(f.flag = 2, constraintDF, equilDF)
...
equilDF <- Perform_Analytical_Run8_2(f.flag = 3, constraintDF, equilDF)
