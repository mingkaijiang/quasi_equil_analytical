...
Perform_Analytical_Run10 <- function(f.flag = 1, cDF, eDF) {
    ...
    cDF[cDF$Run == 10 & cDF$CO2 == 350, 3:13] <- out350DF
    eDF[eDF$Run == 10 & eDF$CO2 == 350, 3:8] <- equil350DF
    ...
    # store constraint and equil DF onto their respective output df
    cDF[cDF$Run == 10 & cDF$CO2 == 700, 3:13] <- out700DF
    eDF[eDF$Run == 10 & eDF$CO2 == 700, 3:8] <- equil700DF
    ...
    if (f.flag == 1) {
        ...
        tiff("Plots/Analytical_Run10.tiff",
